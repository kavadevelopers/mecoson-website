...
<head>
    ...
    @php
        $categories = App\Models\MasterCategories::select('name', 'id', 'slug')
            ->where('is_deleted', '0')
            ->orderby('sort', 'asc')
            ->get();
    @endphp
...
<body>
    ...
    <div class="preloader" style="display: none;">
        <div class="lds-ripple">
            <lottie-player src="{{ url('themes/lottie/loading.json') }}" background="transparent" speed="1" loop
                    ...
                    <div class="col-lg-6">
                        <ul class="heading-left-part">
                            <li>
                                ...
                                <span>Call Us:</span>
                                <a
                                    href="tel:{{ CommonHelper::setting('web_mobile') }}">{{ CommonHelper::setting('web_mobile') }}</a>,
                                <a
                                    href="tel:{{ CommonHelper::setting('web_mobile2') }}">{{ CommonHelper::setting('web_mobile2') }}</a>
                            </li>
                            <li>
                                <i class="bx bx-envelope"></i>
                                <span>Email:</span>
                                <a
                                    href="mailto:{{ CommonHelper::setting('web_email') }}">{{ CommonHelper::setting('web_email') }}</a>
                            </li>
                        </ul>
                    </div>
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <ul class="dropdown-menu">
                                                @foreach ($categories as $category)
                                                    @php
                                                        $products = App\Models\ProductModel::select(
                                                            'name',
                                                            'id',
                                                            'slug',
                                                        )
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="single-widget">
                        <a href="{{ url('') }}">
                            <img src="{{ url('themes/logos/logo-footer.png') }}" style="margin-bottom: 0;"
                                alt="Image">
                        </a>
    ...
    <footer class="footer-bottom-area">
        <div class="container">
            <div class="copy-right">
                <p>Copyright <i class="bx bx-copyright"></i> {{ date('Y') }}
                    {{ CommonHelper::setting('app_name') }}. All rights reserved. Powered By <a
