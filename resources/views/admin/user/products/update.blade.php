...
@section('content')
    ...
    <div class="page-body">
        <form method="post" action="{{ CommonHelper::admin('products/update') }}" enctype="multipart/form-data">
        @csrf
            <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input name="price" type="text" class="form-control decimal-num" value="{{ $item->price>0?$item->price:'' }}" placeholder="Price">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Banner</label>
                                <div>
                                    <img src="{{ CommonHelper::getProductImage($item->image) }}" class="list-image-thumbnail-landscap-auto" id="bannerImage">
                                    <br>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="short_description" type="text" rows="5" class="form-control" placeholder="Short Description" required>{{ $item->short_description }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Content</label>
                                <textarea name="long_description" type="text" class="form-control tinymceeditor" value="" >{{ $item->long_description }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
